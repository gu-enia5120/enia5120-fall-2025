...
::: callout-important
These slides are incomplete as of 11/11/25 4pm.
:::
...
-   Key model diagnostic in Bayesian workflow\
-   Compare replicated data to observed data using R
...
-   Overlay densities for observed vs. simulated data

```{r}
library(bayesplot)
ppc_dens_overlay(y = dat$y, yrep = yrep[1:100, ])
```

## A real example from work

We're trying to plan a new study, based on this figure from a poster by a competitor
