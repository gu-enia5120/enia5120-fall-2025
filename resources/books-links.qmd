...
# {{< fa brands r-project >}} and R-related books

1. Hands-On Programming with R by Garrett Grolemund (2014). <https://rstudio-education.github.io/hopr/>


## Cheatsheets

1. [Getting started with R](https://media.datacamp.com/legacy/image/upload/v1697642178/Marketing/Blog/R_Cheat_Sheet_PNG_1.pdf){target="_blank"} from DataCamp
2. [Various high-quality cheatsheets](https://posit.co/resources/cheatsheets/){target="_blank"} from Posit


# Books
## Data science books

1. Introduction to Statistical Learning with R (2e) by Gareth James, Daniela Witten, Trevor Hastie and Robert Tibshirani (2021). <https://www.statlearning.com/>
1. Elements of Statistical Learning: Data Mining, Inference, and Prediction, Second Edition by Trevor Hastie, Robert Tibshirani, and Jerome Friedman (2009). <https://hastie.su.domains/ElemStatLearn/>
