...
- Code quality
	- Code should be styled/linted using styler/lintr in R 
...
- All output should be formatted. **No raw output**. Use the capabilities of R and Quarto to achieve this.
	- In particular,  consider Rich Iannone's work around `gt`.
